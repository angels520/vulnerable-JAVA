    ...
    <div class="contact">
        ...
        <form action="/MessageListServlet?cmd=addmessage" method="post">
            ...
            <div class="contact-grid">
                ...
                <div class="col-md-6 contact-us">
                    <input type="text" value="问题" name="question" onfocus="this.value='';"
                           onblur="if (this.value == '') {this.value = 'Subject';}">
                </div>
                <div class="clearfix"></div>
            </div>
            <textarea cols="77" rows="6" value=" " name="message" onfocus="this.value='';"
                      onblur="if (this.value == '') {this.value = 'Message';}">消息主体</textarea>
            <div class="send ">
