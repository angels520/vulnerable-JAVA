        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加商品','admin/shop-add.html',600,400)"><i
                            class="layui-icon"></i>添加商品
                    </button>
                    <button class="layui-btn" onclick="xadmin.open('修改商品','admin/shop-edit.html',600,400)"><i
                            class="layui-icon"></i>修改商品
                    </button>
                </div>
                            ...
                            if (request.getAttribute("allshops") != null) {
                                ...
                                for (ShopObject user : users) {
                                    out.print("<tr>\n" +
                                            ...
                                            "<td>" + user.getShopimg() + "</td>\n" +
                                            "<td>" + user.getShopdetail() + "</td>\n" +
                                            "<td class=\"td-manage\">\n" +
                                            "<a title=\"删除\" href=\"/ShopListServlet?cmd=delshop&shopid="+user.getShopid()+"\">\n" +
